    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 120:
                ...
                full_command = f"./bgmi {target} {port} {9} {time} 900"
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. "
                    "To gain access and unleash the power of attacks, you can:\n\n👉 Contact an Admin or the Owner for approval @Roxz_gaming.\n"
                    "🌟 Become a proud supporter and purchase approval @Roxz_gaming.\n💬 Chat with an admin now and level up your capabilities!\n\n"
...
Buy From :- GO TO ADMIN @Roxz_gaming
Official Channel :- @bgmiindiaofficial1 
'''
...
✅Join :- https://t.me/bgmiindiaofficial1 '''
    bot.reply_to(message, response)
